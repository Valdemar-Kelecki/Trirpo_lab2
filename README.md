...
Продукт должен являться игровым приложением для OC Windows и иметь простой интерфейс пользователя. Приложение должно быть реализовано с помощью библиотеки SFML и написано на языке программирования С++. Игра должна иметь понятный и хорошо различимый для пользователя дизайн. Отличия башен от врагов и элементов ландшафта должно быть существенным.
...
Для данного приложения не предусмотрены особые виды пользователей, т.к. оно не имеет каких-либо ограничений.
...
| Левая кнопка мыши | взаимодействие с объектом, над которым распологается курсор. В первую очередь кнопками на панеле строительства башен |
...
4. Хорошо различимые объекты во время игры
...
### 3.2.2 Ограничения
1. Приложение должно быть реализовано на языке C++11(либо выше);
